...
def calcular_mostrar():
    ...
    # Gráfica resultante
    ax.clear()
    ax.plot([0], 0, linestyle='-', color="white", marker="o", markersize=5, markerfacecolor="white")
    ax.plot(Coordenadas_En_X, Coordenadas_En_Y, linestyle='-', color="blue", marker="o", markersize=5, markerfacecolor="red")
    ax.plot([60], 60, linestyle='-', color="white", marker="o", markersize=5, markerfacecolor="white")
    canvas.draw()
